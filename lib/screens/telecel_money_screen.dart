...
class TelecelMoneyPaymentScreen extends StatefulWidget {
  final double montant;
  final String commandeId;
  final String description;

  const TelecelMoneyPaymentScreen({
    super.key,
  ...
  @override
  State<TelecelMoneyPaymentScreen> createState() => _TelecelMoneyPaymentScreenState();
}

class _TelecelMoneyPaymentScreenState extends State<TelecelMoneyPaymentScreen> {
  ...
  static const Color telecelRed = Color(0xFFCC0000);
  static const Color telecelLight = Color(0xFFFFF0F0);
  static const String numeroMarchand = '05XXXXXXXX'; // ← remplacez
  ...
  void _copierNumero() {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(content: Text('Numéro copié !'), backgroundColor: telecelRed, duration: Duration(seconds: 2)),
    );
  }
          ...
          builder: (_) => AlertDialog(
            ...
            content: Column(
              ...
              children: [
                Container(
                  ...
                  decoration: const BoxDecoration(color: telecelLight, shape: BoxShape.circle),
                  child: const Icon(Icons.hourglass_top_rounded, color: telecelRed, size: 48),
                ),
            ...
            actions: [
              TextButton(
                ...
                child: const Text('OK', style: TextStyle(color: telecelRed)),
              ),
            ],
          ),
        );
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                gradient: const LinearGradient(colors: [telecelRed, Color(0xFFFF3333)], begin: Alignment.topLeft, end: Alignment.bottomRight),
                borderRadius: BorderRadius.circular(16),
                boxShadow: [BoxShadow(color: telecelRed.withOpacity(0.3), blurRadius: 12, offset: const Offset(0, 4))],
              ),
              child: Column(
                children: [
            ...
            Row(
              children: [
                ...
                Expanded(child: Container(height: 2, color: _etapeUssd ? Colors.grey.shade300 : telecelRed)),
            ...
            if (_etapeUssd) ...[
              _card(child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 16),
                  _instructionRow('1', 'Composez *130# sur votre téléphone Telecel'),
                  _instructionRow('2', 'Choisissez "Transfert d\'argent"'),
                  _instructionRow('3', 'Entrez le numéro marchand :'),
                  const SizedBox(height: 8),
                  Container(
                    padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 12),
                    decoration: BoxDecoration(color: telecelLight, borderRadius: BorderRadius.circular(10), border: Border.all(color: telecelRed.withOpacity(0.4))),
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        Text(numeroMarchand, style: const TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: telecelRed, letterSpacing: 2)),
                        IconButton(icon: const Icon(Icons.copy, color: telecelRed), tooltip: 'Copier', onPressed: _copierNumero),
                      ],
                    ),
                  ),
                  const SizedBox(height: 8),
              ...
              SizedBox(
                ...
                child: ElevatedButton.icon(
                  ...
                  style: ElevatedButton.styleFrom(
                    backgroundColor: telecelRed, foregroundColor: Colors.white,
              ...
              _card(child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 8),
                    const Text('Renseignez les informations de votre transfert Telecel Money.',
                    ...
                    TextFormField(
                      ...
                      maxLength: 10,
                      decoration: _inputDeco(label: 'Votre numéro Telecel Money', hint: 'Ex: 0550000000', icon: Icons.phone_android),
                      validator: (v) {
                    ...
                    TextFormField(
                      ...
                      decoration: _inputDeco(label: 'Référence de transaction', hint: 'Ex: TC241213XXXXXXX', icon: Icons.confirmation_number_outlined),
                      validator: (v) {
                        if (v == null || v.isEmpty) return 'Champ obligatoire';
    ...
    child: Row(
      ...
      children: [
        Container(
          ...
          decoration: const BoxDecoration(color: telecelRed, shape: BoxShape.circle),
  ...
  Widget _stepIndicator(int num, String label, bool actif) => Column(
    children: [
      AnimatedContainer(
        ...
        decoration: BoxDecoration(color: actif ? telecelRed : Colors.grey.shade300, shape: BoxShape.circle),
        child: Text('$num', style: TextStyle(color: actif ? Colors.white : Colors.grey, fontWeight: FontWeight.bold)),
      ),
      const SizedBox(height: 4),
      Text(label, style: TextStyle(fontSize: 11, color: actif ? telecelRed : Colors.grey, fontWeight: actif ? FontWeight.bold : FontWeight.normal)),
    ],
  );

  InputDecoration _inputDeco({required String label, required String hint, required IconData icon}) => InputDecoration(
    labelText: label, hintText: hint,
    prefixIcon: Icon(icon, color: telecelRed),
    filled: true, fillColor: const Color(0xFFFAFAFA),
    border: OutlineInputBorder(borderRadius: BorderRadius.circular(12), borderSide: BorderSide(color: Colors.grey.shade300)),
    focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(12), borderSide: const BorderSide(color: telecelRed, width: 2)),
